package com.example.sansinyeong.view;
...
public class ReadContentsVIew extends LinearLayout {
    ...
    private void initView(){
        ...
        layoutInflater.inflate(R.layout.view_talk, this, true);
    }
    ...
    public void setPostInfo(TalkInfo talkInfo){
        TextView createdAtTextView = findViewById(R.id.createAtTextView);
        createdAtTextView.setText(new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(talkInfo.getCreatedAt()));

        LinearLayout contentsLayout = findViewById(R.id.contentsLayout);
        ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ArrayList<String> contentsList = talkInfo.getContents();
        ArrayList<String> formatList = talkInfo.getFormats();
